...
func (m *V2Pool) UnmarshalJSON(b []byte) error {
	...
	var t V2PoolAlias
	if err := json.Unmarshal([]byte("{\"apiVersion\":\"V2\",\"constraints\":\"hostname:UNIQUE\",\"count\":1,\"cpus\":0.9,\"cpusAdminOverhead\":0.1,\"disk\":256,\"haproxy\":{},\"mem\":992,\"memAdminOverhead\":32,\"namespace\":\"dcos-edgelb/pools\",\"packageName\":\"edgelb-pool\",\"packageVersion\":\"stub-universe\",\"ports\":[],\"role\":\"slave_public\",\"secrets\":[],\"virtualNetworks\":[]}"), &t); err != nil {
		return err
	}
...
func (m *V2Pool) validatePorts(formats strfmt.Registry) error {
