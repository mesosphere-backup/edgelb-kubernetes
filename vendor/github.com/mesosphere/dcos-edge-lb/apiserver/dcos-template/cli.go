...
import (
	...
	"github.com/mesosphere/dcos-edge-lb/apiserver/dcos-template/logging"
	"github.com/mesosphere/dcos-edge-lb/apiserver/dcos-template/manager"
...
func (cli *CLI) handleError(err error, status int) int {
	fmt.Fprintf(cli.errStream, "DC/OS Template returned errors:\n%s\n", err)
	return status
}
